...
struct acter_group { 	struct acter* member[ACTER_GROUP_MAX];
			unsigned int count;			};
...
int acter_group_assign(struct acter_group*, struct acter*);

int acter_group_resign(struct acter_group*, struct acter*);
